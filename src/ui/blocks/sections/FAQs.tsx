...
import { SdsAccordion, SdsAccordionItem, SdsTextContentHeading } from "primitives";
    ...
    <Section padding={sectionPadding} variant="neutral">
      <Flex container direction="column" alignSecondary="stretch" gap={flexGap}>
        ...
        <Flex container type="third" alignPrimary="center">
          <FlexItem size="major">
            <SdsAccordion>
              <SdsAccordionItem title="What is Simple Design System (SDS)?">
              ...
              <SdsAccordionItem title="How do I install SDS in my project?">
              ...
              <SdsAccordionItem title="Where can I find component documentation?">
